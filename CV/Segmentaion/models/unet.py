...
class UNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=2):
        ...
        self.up5 = Up_Conv_Block(in_channels=1024, out_channels=512)
        self.up_conv5 = Conv_Block(in_channels=1024, out_channels=512)

        self.up4 = Up_Conv_Block(in_channels=512, out_channels=256)
        self.up_conv4 = Conv_Block(in_channels=512, out_channels=256)

        self.up3 = Up_Conv_Block(in_channels=256, out_channels=128)
        self.up_conv3 = Conv_Block(in_channels=256, out_channels=128)

        self.up2 = Up_Conv_Block(in_channels=128, out_channels=64)
