...
class DenseNet121(DenseNet):
    def __init__(self, n_classes=10, growth_rate=32, **kwargs):
        super().__init__(layers=[6, 12, 24, 16], growth_rate=growth_rate, init_ch=64, n_classes=n_classes)

class DenseNet169(DenseNet):
    def __init__(self, n_classes=10, growth_rate=32, **kwargs):
        super().__init__(layers=[6, 12, 32, 32], growth_rate=growth_rate, init_ch=64, n_classes=n_classes)

class DenseNet201(DenseNet):
    def __init__(self, n_classes=10, growth_rate=32, **kwargs):
        super().__init__(layers=[6, 12, 48, 32], growth_rate=growth_rate, init_ch=64, n_classes=n_classes)

class DenseNet264(DenseNet):
    def __init__(self, n_classes=10, growth_rate=32, **kwargs):
        super().__init__(layers=[6, 12, 64, 48], growth_rate=growth_rate, init_ch=64, n_classes=n_classes)